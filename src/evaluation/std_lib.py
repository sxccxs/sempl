...
from src.evaluation.builtin_funcs import INPUT_ENTRY, LEN_ENTRY, PRINT_ENTRY
...
STD_LIB = Scope(
    {
        "Type": TypeEntry(value_types.Type(value_types.Type)),
        ...
        "Arr": TypeEntry(value_types.Type(value_types.Array)),
